        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trainer
                    </th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach($classes as $class)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $class->trainer->user->name ?? 'N/A' }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <button wire:click="delete({{ $class->id }})" class="text-red-600 hover:text-red-900"
                ...
                <div
                    ...
                    <form wire:submit.prevent="store">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mb-4">
                                <label for="trainer_id" class="block text-gray-700 text-sm font-bold mb-2">Trainer:</label>
                                <select wire:model="trainer_id" id="trainer_id"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                @error('trainer_id') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                            <div class="mb-4">
