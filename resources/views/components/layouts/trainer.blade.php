...
<head>
    ...
    <title>{{ $title ?? 'Trainer Dashboard' }} - AlphaMode</title>
        ...
        <aside class="w-64 bg-base-300 text-base-content flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="{{ route('trainer.dashboard') }}"
                    class="block px-4 py-2 rounded hover:bg-base-100 {{ request()->routeIs('trainer.dashboard') ? 'bg-base-100' : '' }}">Dashboard</a>
                <a href="{{ route('dashboard') }}" class="block px-4 py-2 rounded hover:bg-base-100">My Profile</a>
            </nav>
